...
public class BgGroup3 extends Group {
    private Texture texture;
    private ShaderProgram shadowProgram;
    public BgGroup3(float width, float height){
        texture = Asset.getAsset().getTexture("noise.png");
        shadowProgram = new ShaderProgram(
                Gdx.files.internal("gamee/middlespread2.vert"),
                Gdx.files.internal("gamee/middlespread2.frag"));
