package com.tony.shader.screen.base;
...
public class BaseScreen implements Screen {
    ...
    private Batch getBatch() {
        return ShaderUtills.instence().getBatch();
    }

    private ExtendViewport getStageViewport() {
        return ShaderUtills.instence().getStageViewport();
    }
...
//        CocosResource.unLoadFile(viewpath);
    ...
    public void setScreen(BaseScreen screen) {
        ShaderUtills.instence().setScreen(screen);
    }
